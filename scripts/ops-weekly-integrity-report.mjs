const BASE_URL = process.env.BASE_URL || process.env.API_BASE_URL || 'https://www.madridliveapp.top';
...
async function fetchJson(url) {
  if (!ADMIN_API_TOKEN) {
    throw new Error('ADMIN_API_TOKEN is required for protected weekly integrity reads.');
  }
